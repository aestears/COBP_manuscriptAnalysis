...
Then, simulate the minimum standard deviatino for each sandbank vital rate 
```{r}
corr.outSB.sd_min <- sd(car::logit(seq(from = outSB*.9, to = outSB*1.1, length.out = 20)))
corr.staySB.sd_min <- sd(car::logit(seq(from = staySB*.9, to = staySB*1.1, length.out = 20)))
corr.goCont.sd_min <- sd(car::logit(seq(from = goCont*.9, to = goCont*1.1, length.out = 20)))
corr.goSB.sd_min <- sd(car::logit(seq(from = goSB*.9, to = goSB*1.1, length.out = 20)))
```

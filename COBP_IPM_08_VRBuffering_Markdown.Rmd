...
ggplot(bigDF_minSbSd) +
  ...
  geom_pointrange(aes(x = mean_VSS, y = mean_corrSD, xmin = (mean_VSS - sd_VSS), xmax = (mean_VSS + sd_VSS), col = VitalRate)) +
  geom_pointrange(aes(x = mean_VSS, y = mean_corrSD, ymin = mean_corrSD - sd_corrSD, ymax = mean_corrSD + sd_corrSD, col = VitalRate)) + 
  xlab("mean VSS") +
  ylab("mean corrected SD") + 
  geom_text(aes(x = 1, y = 2.5, label = paste0("corr=", round(cor_minSbSd$estimate, 2),"; P-val=", round(cor_minSbSd$p.value, 3)))) +
  theme_classic() +
...
# add the information for growth (which is a matrix)
...
ggplot(bigDF_maxSbSd) +
  ...
  xlab("mean VSS") +
  ylab("mean corrected SD") + 
  geom_text(aes(x = 1, y = 2.5, label = paste0("corr=", round(cor_maxSbSd$estimate, 2),"; P-val=", round(cor_maxSbSd$p.value, 3)))) +
  theme_classic() +
